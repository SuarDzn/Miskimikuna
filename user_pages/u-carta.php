...
<body bgcolor="#101010">
    <section class="sub-header">
        ...
        <h1>Nuestra Carta</h1><br><br>
        <a href="https://drive.google.com/file/d/1GO9KE6Xp3yK9QkvMRa6QvWXfzg-AK6eX/view?usp=sharing" class="hero-btn" target="_blank" rel="noopener noreferrer">Descarga La Carta</a>
    ...
    <section class="menu container">
        ...
        <div class="scroll-menu" id="navbar">
            ...
            <a href="#sanguches-1" class="section-title">Sánguches</a>
            <a href="#anticuchos-1" class="section-title">Anticuchos</a>
            <a href="#cocina_criolla-1" class="section-title">Cocina Criolla</a>
            <a href="#cervezas-1" class="section-title">Cervezas</a>
            <a href="#aguas-1" class="section-title">Aguas</a>
    ...
    <div class="entradas dishes" id="sanguches-1">
        <h3>Sanguches</h3>
        <p>"El dinero no puede comprar la felicidad, pero si uno de nuestros sándwiches"</p>
        <div class="box-container" id="sanguches"></div>
    </div>
    ...
    <div class="entradas dishes" id="cocina_criolla-1">
        <h3>Cocina Criolla</h3>
        <p>"Nadie puede ser sensato con el estómago vacío"</p>
        <div class="box-container" id="cocina_criolla"></div>
    </div>
    ...
    <div class="entradas dishes" id="aguas-1">
        <h3>Aguas</h3>
        <p>"¡Agua! La única bebida del hombre sabio"</p>
        <div class="box-container" id="aguas"></div>
    </div>
