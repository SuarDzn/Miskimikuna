    ...
    <section class="nosotros">
        <div class="row">
            <div class="nosotros-col">
                ...
                <p>Huasi es una cadena de restaurantes enfocada en la satisfaccion alimenticia de nuestros clientes.
                    La palabra Huasi proviene del quechua "hogar", implementamos su significado en nombre de la compañia
                    con la finalidad de dar
                    una comodidad similar adecuada a todos nuestros comensales.</p>
                <a href=https://chats.landbot.io/v3/H-1251777-9TFXQOJLYPZO1D4X/index.html target="_blank" rel="noopener noreferrer" class="hero-btn white-btn">Conoce Más</a>
            </div>
            <div class="nosotros-col">
