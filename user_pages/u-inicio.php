...
<body bgcolor="#101010">
    <section class="header">
        ...
        <div class="text-box">
            <h1>¡La comida criolla como nunca antes la probaste!</h1><br>
            <p>
                "En Huasi te sentiras como en casa. Esperemos disfrutes de nuestro servicio <br>
                y los deliciosos platos que brindamos para el gusto de su paladar"
            </p>
            <a href="https://form.jotform.com/221907531516049" class="hero-btn" target="_blank" rel="noopener noreferrer">Haz Una Reserva</a>
        </div>
    ...
    <section class="dishes">
        ...
        <div class="box-container" id="promociones">
            ...
            <div class="box">
                <img src="../img/promocion_1.png" alt="">
                <h3>Sánguche de Lomo</h3>
                <div class="stars">
            ...
            <div class="box">
                <img src="../img/promocion_2.png" alt="">
                <h3>La Causa Limeña de Pollo</h3>
                <div class="stars">
            ...
            <div class="box">
                <img src="../img/promocion_3.png" alt="">
            ...
            <div class="box">
                <img src="../img/promocion_4.png" alt="">
                <h3>Cau Cau de Mondongo</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <button class="btn" data-id="22">Añadir a la Cesta</button>
            </div>
        </div>
