...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <form class="" action="../controller/update_product.php?id=<?php echo $product_id?>" method="POST">
                ...
                <input type="text" class="login-input" placeholder="Link de la Imagen*" name="img_url" required />
                <div class="center"><input type="submit" value="Editar Producto" class="hero-btn inverted-btn" /></div>
            </form>
