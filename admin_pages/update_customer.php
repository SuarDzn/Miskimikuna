...
<head>
    ...
    <title>Huasi - Editar Cliente</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <form class="" action="../controller/update_customer.php?id=<?php echo $customer_id?>" method="POST">
                ...
                <div class="center"><input type="submit" value="Editar Cliente" class="hero-btn inverted-btn" /></div>
            </form>
