...
<head>
    ...
    <title>Huasi - Añadir Usuario</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <form class="" action="../controller/add_user.php" method="POST">
                ...
                <div class="center"><input type="submit" value="Añadir Usuario" class="hero-btn inverted-btn" /></div>
            </form>
